<script lang="ts">
	...
	const attractions = [
		{
			...
			description:
				'Marvel at the magical blue light in this sea cave. Best visited in morning with calm seas.',
			image:
		...
		},
		{
			...
			description:
				'Iconic limestone sea stacks rising from the azure waters. Take a boat tour around them.',
			image:
				'https://images.unsplash.com/photo-1605640840605-14ac1855827b?w=800&q=80',
			duration: 'Perfect for photos',
			icon: Camera
		},
		{
			name: 'Gardens of Augustus',
			description: 'Terraced gardens with spectacular views of Faraglioni and Via Krupp.',
			image:
		...
		},
		{
			name: 'Villa Jovis',
			description:
				"Ruins of Emperor Tiberius' villa with panoramic views. A scenic hike from Capri town.",
			image:
		...
		{
			name: 'Anacapri & Monte Solaro',
			description: "Take the chairlift to the island's highest point for 360-degree views.",
			image:
		...
		},
		{
			name: 'La Piazzetta',
			description:
				"The island's famous square, perfect for people-watching with an espresso.",
			image:
				'https://images.unsplash.com/photo-1519046904884-53103b34b206?w=800&q=80',
			duration: 'Iconic spot',
			icon: Camera
		}
	];
	...
	const restaurants = [
		{
			name: 'Da Luigi ai Faraglioni',
			type: 'Beachfront Dining',
			description:
				'Iconic beach club restaurant accessible by boat, serving fresh seafood with views of the Faraglioni.',
			cuisine: 'Fresh Seafood, Mediterranean',
			price: '€€€'
		},
		{
			name: 'Ristorante Aurora',
			type: 'Traditional Italian',
			description:
				'Historic restaurant near the Piazzetta, favorite of celebrities, known for excellent pasta and atmosphere.',
			cuisine: 'Italian Cuisine, Fine Dining',
			price: '€€€€'
		},
		{
			name: 'La Capannina',
			type: 'Local Favorite',
			description:
				'Family-run restaurant with beautiful garden setting, serving authentic Caprese cuisine since 1931.',
			cuisine: 'Traditional Caprese, Garden Dining',
			price: '€€€'
		}
	];
	...
	const tips = [
		{
			...
			description:
				'May-June and September-October for pleasant weather and fewer crowds. Summer is beautiful but very busy.'
		},
		{
			title: 'How Long to Stay',
			description:
				'Full day trip recommended. Overnight stay allows you to experience the island after day-trippers leave.'
		},
		{
			title: 'What to Bring',
			description:
				"Comfortable walking shoes, sunscreen, hat, and swimwear. Bring cash as some places don't accept cards."
		},
		{
			title: 'Budget Estimate',
			description:
				'Ferry €40, Blue Grotto €14, lunch €30-50, extras €20-50. Total: €100-150+ per person.'
		}
	];
</script>
	...
	<section class="relative bg-white py-32">
		<div class="container mx-auto max-w-4xl px-4">
			<div class="animate-fade-in-up">
				...
				<p class="text-center text-lg leading-relaxed text-(--stone)">
	...
	<section class="relative bg-(--cream) py-32">
		<div class="container mx-auto px-4 sm:px-6 lg:px-8">
			<div class="scroll-reveal mb-20 text-center">
				...
				<p class="mx-auto max-w-2xl text-xl text-(--stone)">Discover the magic of Capri</p>
			</div>
								...
								<CardContent class="p-8">
									<div class="mb-4 flex flex-col md:flex-row md:items-start md:justify-between">
										...
										<div class="mb-2 flex items-center space-x-2 md:mb-0">
											<Euro class="h-5 w-5 text-(--stone)" />
											<span class="text-lg font-semibold text-(--stone)">{restaurant.price}</span>
										</div>
									</div>
									<p class="mb-4 leading-relaxed text-(--stone)">
										{restaurant.description}
									</p>
									<div class="flex items-center text-sm text-(--stone)">
								...
								<div class="grow">
									...
									<div class="grid grid-cols-1 gap-6 md:grid-cols-2">
										...
										>
											...
											<div class="space-y-1 text-sm text-(--stone)">
							...
							<div class="rounded-xl bg-(--sand) p-6">
								...
								<ul class="space-y-3">
									{#each ['Book tickets in advance during peak season (June-September)', 'First ferry of the day (usually 7:30am) offers fewer crowds and best Blue Grotto conditions', 'Return ferries fill up - book your return when you arrive or risk waiting hours', 'Consider a round-island boat tour from Sorrento for a different perspective'] as tip}
										<li class="flex items-start space-x-3 text-sm text-(--stone)">
						...
						<div class="scroll-reveal" style="transition-delay: {index * 0.1}s">
							...
							>
								<CardContent class="p-8">
									...
									<p class="leading-relaxed text-(--stone)">{tip.description}</p>
								</CardContent>
							</Card>
						</div>
					{/each}
