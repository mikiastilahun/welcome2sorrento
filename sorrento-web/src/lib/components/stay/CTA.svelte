<script lang="ts">
	...
	const heading = pageData?.cta?.heading || 'Need Help Finding Accommodation?';
	const description =
		pageData?.cta?.description ||
		'We can help you find and reserve the perfect place for your stay';
...
<section class="relative py-20">
	<div class="absolute inset-0">
		{#if backgroundImage}
			<img src={backgroundImage} alt="Luxury accommodation" class="h-full w-full object-cover" />
		{/if}
