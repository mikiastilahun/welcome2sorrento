...
// Restaurant Queries
export const restaurantsQuery = groq`*[_type == "restaurant"] | order(order asc) {
  _id,
  name,
  slug,
  category,
...
export const restaurantsByCategoryQuery = groq`*[_type == "restaurant" && category == $category] | order(order asc) {
  _id,
  name,
  slug,
  category,
...
export const accommodationsQuery = groq`*[_type == "accommodation"] | order(order asc) {
  _id,
  name,
  slug,
  type,
...
// Activity Queries
export const activitiesQuery = groq`*[_type == "activity"] | order(order asc) {
  _id,
  name,
  slug,
  category,
...
export const activitiesByCategoryQuery = groq`*[_type == "activity" && category == $category] | order(order asc) {
  _id,
  name,
  slug,
  category,
