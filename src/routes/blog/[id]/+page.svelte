...
<style>
	...
	:global(.prose h1) {
		@apply mb-6 text-4xl font-bold text-[color:var(--dark)] sm:text-5xl;
	}

	:global(.prose h2) {
		@apply mb-4 text-3xl font-bold text-[color:var(--dark)] sm:text-4xl;
	}

	:global(.prose h3) {
		@apply mb-3 text-2xl font-bold text-[color:var(--dark)] sm:text-3xl;
	}

	:global(.prose h4) {
		@apply mb-2 text-xl font-bold text-[color:var(--dark)] sm:text-2xl;
	}
	...
	:global(.prose a) {
		@apply text-[color:var(--purple-lavender)] underline transition-colors hover:text-[color:var(--deep-purple)];
	}

	:global(.prose strong) {
		@apply font-bold text-[color:var(--dark)];
	}
	...
	:global(.prose blockquote) {
		@apply my-6 border-l-4 border-[color:var(--purple-lavender)] bg-[color:var(--off-white)] py-4 pl-6 pr-4 italic;
	}

	:global(.prose img) {
		@apply my-8 rounded-2xl shadow-lg;
	}
</style>
