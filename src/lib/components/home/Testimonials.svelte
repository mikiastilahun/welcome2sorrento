...
{#if displayTestimonials.length > 0}
	<section class="relative overflow-hidden bg-[var(--sand)] py-24">
		...
		<div class="relative">
			...
			<!-- Marquee track -->
			<div class="animate-marquee flex gap-6 py-4 hover:[animation-play-state:paused]">
				{#each marqueeItems as testimonial, index}
					<div class="w-[400px] max-w-[90vw] flex-shrink-0">
						<div
							class="group shadow-mediterranean hover:shadow-mediterranean-lg relative h-full rounded-xl border border-[var(--sand)] bg-white p-6 transition-all duration-300 hover:-translate-y-1"
						>
							...
							<blockquote class="relative">
								<p class="mb-6 font-serif text-lg leading-relaxed text-[var(--charcoal)] italic">
									"{testimonial.text}"
								</p>
							...
							<div class="absolute right-4 bottom-4 opacity-10">
								<svg
									class="h-8 w-8 text-[var(--terracotta)]"
									viewBox="0 0 32 32"
									fill="currentColor"
								>
									<path
		...
		<div class="container mx-auto mt-16 px-4 sm:px-6 lg:px-8">
			<div class="scroll-reveal" use:reveal>
				<div
					class="shadow-mediterranean-lg relative mx-auto max-w-4xl rounded-2xl border border-[var(--sand)] bg-white p-8 md:p-12"
				>
