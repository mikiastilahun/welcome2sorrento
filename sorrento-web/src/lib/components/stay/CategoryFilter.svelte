				...
				{#each types as type}
					<Button
						...
						class={selectedType === type
							? 'bg-(--azure) hover:bg-(--deep-azure) text-white transition-all duration-200'
							: 'border-(--sand) text-(--charcoal) hover:border-(--azure) hover:text-(--azure) border transition-all duration-200'}
					>
