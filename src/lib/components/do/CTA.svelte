<script lang="ts">
	...
	const heading = pageData?.cta?.heading || 'Ready to Book Your Activities?';
	const description =
		pageData?.cta?.description ||
		'Let us help you plan the perfect activities for your Sorrento adventure';
...
<section class="relative py-20">
	<div class="absolute inset-0">
		{#if backgroundImage}
			<img src={backgroundImage} alt="Sorrento activities" class="h-full w-full object-cover" />
		{/if}
